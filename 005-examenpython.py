...
def menu():
    ...
    if opcion == "1":
        ...
        nombre = print("Nombre del cliente")
        apellidos = print("Apellidos del cliente")
        direccion = print("Direccion del cliente")
        telefono = print("Telefono del cliente")
        email = print("Email del cliente")
